...
public class wrappedSetProductsTest {
    ...
    public void test1(){
        ...
        wrappedWeightProduct wrappedWeightProduct1 = new wrappedWeightProduct(wrap2, Wproduct1, 1.);
        wrappedSetProducts PrSet = new wrappedSetProducts(wrap1, wrappedWeightProduct1);
        productWrap wrap3 = new productWrap("box", 1.);
        wrappedSetProducts PrSet1 = new wrappedSetProducts(wrap3, wrappedPieceProduct1, PrSet );
        wrappedSetProducts PrSet2 = new wrappedSetProducts(wrap2, wrappedPieceProduct1, PrSet );
        wrappedSetProducts PrSet3 = new wrappedSetProducts(wrap3, wrappedPieceProduct1, PrSet );
    ...
    public void test2(){
        ...
        wrappedWeightProduct wrappedWeightProduct1 = new wrappedWeightProduct(wrap2, Wproduct1, 2.0);
        productWrap wrap3 = new productWrap("box", 0.05);
        wrappedSetProducts PrSet1 = new wrappedSetProducts(wrap3, wrappedPieceProduct1, wrappedWeightProduct1 );
    ...
    public void test3(){
        ...
        wrappedWeightProduct wrappedWeightProduct1 = new wrappedWeightProduct(wrap2, Wproduct1, 2.0);
        productWrap wrap3 = new productWrap("box", 0.05);
        wrappedSetProducts PrSet1 = new wrappedSetProducts(wrap3, wrap1, wrappedWeightProduct1 );
